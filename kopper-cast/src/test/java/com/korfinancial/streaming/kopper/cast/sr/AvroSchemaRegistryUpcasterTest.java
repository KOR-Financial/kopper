...
import static com.korfinancial.streaming.kopper.cast.sr.Schemas.SCHEMA_V1;
import static com.korfinancial.streaming.kopper.cast.sr.Schemas.SCHEMA_V2;
import static com.korfinancial.streaming.kopper.cast.sr.Schemas.SCHEMA_V3;
import static com.korfinancial.streaming.kopper.cast.sr.Schemas.SCHEMA_V4;
import static com.korfinancial.streaming.kopper.cast.sr.Schemas.SCHEMA_V5;
...
class AvroSchemaRegistryUpcasterTest {
	...
	void performUpcast() throws UpcasterException {
		...
		UpcasterChain<GenericRecord, Integer> chain = upcasterRegistry.getUpcasters(SUBJECT);
