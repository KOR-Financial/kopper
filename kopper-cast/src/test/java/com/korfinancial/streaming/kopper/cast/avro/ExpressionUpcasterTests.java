...
public class ExpressionUpcasterTests {
	...
	void readV1ToV3() throws UpcasterException {
		UpcasterChain<GenericRecord, Integer> chain = new UpcasterChain<>();
		chain.registerUpcaster(ExpressionUpcasters.V2_TO_V3_UPCASTER);
	...
	void readV1ToV4() throws UpcasterException {
		UpcasterChain<GenericRecord, Integer> chain = new UpcasterChain<>();
		chain.registerUpcaster(ExpressionUpcasters.V2_TO_V3_UPCASTER);
		chain.registerUpcaster(ExpressionUpcasters.V3_TO_V4_UPCASTER);
	...
	void readV1ToV5() throws UpcasterException {
		...
		chain.registerUpcaster(ExpressionUpcasters.V2_TO_V3_UPCASTER);
		chain.registerUpcaster(ExpressionUpcasters.V3_TO_V4_UPCASTER);
		chain.registerUpcaster(ExpressionUpcasters.V4_TO_V5_UPCASTER);
