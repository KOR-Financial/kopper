...
public abstract class Payloads {
	...
	public static GenericRecord RECORD_V1 = new GenericRecordBuilder(Schemas.SCHEMA_V1)
		.set("name", "Daan Gerits")
		.set("username", "daang")
		.build();
	...
	public static GenericRecord RECORD_V3 = new GenericRecordBuilder(Schemas.SCHEMA_V3)
		.set("name", "Daan Gerits")
		.set("username", "daang")
		.set("age", 39)
		.build();
	...
	public static GenericRecord RECORD_V4 = new GenericRecordBuilder(Schemas.SCHEMA_V4)
		.set("firstname", "Daan")
		.set("lastname", "Gerits")
		.set("username", "daang")
		.set("age", 39)
	...
	public static GenericRecord RECORD_V5 = new GenericRecordBuilder(Schemas.SCHEMA_V5)
		.set("name", new GenericRecordBuilder(Schemas.SCHEMA_V5.getField("name").schema())
			.set("firstname", "Daan")
			.set("lastname", "Gerits")
			.build())
		.set("username", "daang")
